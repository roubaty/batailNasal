...
public interface IConstantsGlobal {
	...
	public static final int TYPESPRAY = 3;
	public static final int TYPEADDMORVE = 4;
	public static final int TYPEADDMORVE_START = 5;
	public static final int TYPECHANGELANGAGE = 6;
	public static final int TYPECHANGESOUNDS = 7;
	public static final int TYPEPLAYERWIN = 8;
	public static final int TYPEIAWIN = 9;
	public static final int TYPEIAADDMORVE = 10;
	public static final int TYPEIATRIPLE = 11;
